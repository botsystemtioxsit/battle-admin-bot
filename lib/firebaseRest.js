...
// Используется и из api/claude-assistant.js (Vercel), и из
// .github/scripts/run-assistant.js (GitHub Actions) — общий код для обоих
// способов запуска ассистента, см. lib/assistantCore.js.
